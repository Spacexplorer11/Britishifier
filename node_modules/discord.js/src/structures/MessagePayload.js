...
class MessagePayload {
  ...
  resolveBody() {
    ...
    if (Array.isArray(this.options.components)) {
      components = this.options.components.map(component => new ActionRowBuilder(component).toJSON());
    }
  ...
  static create(target, options, extra = {}) {
    return new this(
      target,
      typeof options !== 'object' || options === null ? { content: options, ...extra } : { ...options,
        ...extra },
        );
      }
    }
